    ...
    <el-row>
      <xt-search @click="handleSearch">
        <el-form :inline="true" :model="filters">
          ...
          <el-form-item class="el-form-item-search">
            <el-input v-model="filters.roleName" placeholder="角色名称" size="small"></el-input>
          </el-form-item>
          <el-form-item class="el-form-item-search">
            <el-input v-model="filters.roleCode" placeholder="角色编码" size="small"></el-input>
          </el-form-item>
        </el-form>
...
<script type="text/ecmascript-6">
  import XtSearch from "../../components/search.vue";
