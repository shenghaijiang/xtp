            ...
            checkBoxChange(item){
                ...
                UserMenuOperationAPI.insertUserMenuOperation(params).then(function (res) {
                    if(res.data.code==1){
                        ...
                        let newParams={id:newAddForm.menuId,name:newAddForm.menuName,userId:newAddForm.userId,roleName:newAddForm.roleName,fieldName:newAddForm.fieldName,symbol:newAddForm.symbol,value:newAddForm.value}
            ...
            editRoleDataSure(item){
                ...
                RoleDataRuleAPI.updateRoleDataRule(params).then(function (res) {
                    if(res.data.code==1){
                        ...
                        let newParams={id:paramsAddForm.menuId,name:paramsAddForm.menuName,userId:paramsAddForm.userId,roleName:paramsAddForm.roleName,fieldName:paramsAddForm.fieldName,symbol:paramsAddForm.symbol,value:paramsAddForm.value};
                        _this.getRoleData(newParams)
                    }
                    ...
                    if (valid) {
                        ...
                        RoleDataRuleAPI.insertRoleDataRule(params).then(function (res) {
                            if(res.data.code==1){
                                ...
                                let newParams={id:params.menuId,name:params.menuName,userId:params.userId,roleName:params.roleName,fieldName:params.fieldName,symbol:params.symbol,value:params.value}
                                _this.getRoleData(newParams)
